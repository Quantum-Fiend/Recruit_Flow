        ...
        {!file ? (
          ...
          >
            ...
            <div className="text-center space-y-4">
              <h3 className="text-2xl font-black tracking-tighter">Deploy Resume Portfolio</h3>
              <p className="text-sm text-muted-foreground font-medium max-w-xs mx-auto leading-relaxed">
                Drag and drop your professional identity (PDF/DOCX) or click to browse.
              </p>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-6 w-full">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-black text-xl truncate tracking-tight">{file.name}</p>
                <div className="flex items-center gap-3 mt-1">
                   <Badge variant="outline" className="text-[10px] font-black uppercase tracking-widest border-foreground/10">
                     {(file.size / 1024 / 1024).toFixed(2)} MB
                   </Badge>
                   <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Ready for Ingestion</span>
                </div>
              </div>
              <Button
                variant="ghost"
