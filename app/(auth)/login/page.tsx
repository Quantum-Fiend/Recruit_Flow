...
import { Loader2, ArrowRight, Lock, Mail, Command, Sparkles, ShieldCheck } from "lucide-react"
    ...
    <div className="flex flex-col items-center justify-center min-h-[85vh] w-full px-6">
      ...
      >
        <div className="text-center mb-12 space-y-4">
           ...
           <h1 className="h-lg text-sapphire tracking-tighter">System Access.</h1>
           <p className="text-lg text-muted-foreground font-medium">Verify your professional credentials to enter the console.</p>
        </div>
          ...
          <CardContent className="p-10 space-y-8">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between px-2">
                   <Label htmlFor="email" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Network Identifier</Label>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between px-2">
                  ...
                  <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-primary hover:text-primary/80 transition-colors">Recover</Link>
                </div>
                <div className="relative">
            ...
            <div className="pt-6 border-t border-foreground/5 text-center">
               <p className="text-sm font-medium text-muted-foreground">
                  New to RecruitFlow?{" "}
                  <Link href="/signup" className="text-primary font-black hover:underline underline-offset-4 ml-1">
                    Initialize Account
                  </Link>
               </p>
            </div>
